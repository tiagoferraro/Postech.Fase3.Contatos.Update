...
namespace Postech.Fase3.Contatos.Update.Infra.Messaging;
...
public class RabbitMqConsumer
{
    ...
    private static readonly Counter MessagesProcessed = Metrics.CreateCounter("rabbitmq_messages_processed_ContatosUpdate", "Número de mensagens processadas com sucesso");
    private static readonly Counter MessagesFailed = Metrics.CreateCounter("rabbitmq_messages_failed_ContatosUpdate", "Número de mensagens que falharam ao processar");
    private static readonly Histogram MessageProcessingDuration = Metrics.CreateHistogram("rabbitmq_message_processing_duration_seconds_ContatosUpdate", "Duração do processamento das mensagens", new HistogramConfiguration
    {
